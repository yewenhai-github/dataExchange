...
public class Exs_LocalFloderToMerge extends MainServlet implements IGlobalService{
	private static final long serialVersionUID = 1L;
	
	public Exs_LocalFloderToMerge(String param) {
		super();
		SetCheckLogin(false);
	}
	...
	public void DoCommand() throws Exception {
		...
		bean.setServiceMode(ExsConstants.XmlToFloderMerge);
