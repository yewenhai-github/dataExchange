...
public class Exs_LocalFloderToSplit extends MainServlet implements IGlobalService{
	private static final long serialVersionUID = 1L;
	
	public Exs_LocalFloderToSplit(String param) {
		super();
		SetCheckLogin(false);
	}
	...
	public void DoCommand() throws Exception {
		...
		bean.setServiceMode(ExsConstants.XmlToFloderSplit);
