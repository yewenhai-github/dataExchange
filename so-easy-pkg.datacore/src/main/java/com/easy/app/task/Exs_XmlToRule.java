...
public class Exs_XmlToRule extends MainServlet implements IGlobalService{
	private static final long serialVersionUID = 1L;
	
	public Exs_XmlToRule(String param) {
		super();
		SetCheckLogin(false);
	}
	...
	public void DoCommand() throws Exception {
		...
		bean.setServiceMode(ExsConstants.ElecDocs);
		ExsUtility.ElecDocs(bean, DataAccess);
	}
