if (top.Theme) {
    document.write('<link href="css/' + top.Theme + '/tree.css" rel="stylesheet" type="text/css" />');
}
else {
    document.write('<link href="GetCSS?tree.css" rel="stylesheet" type="text/css" />');
}
...
var TreeView = function (id) {
    ...
    if (!tree) {
        ...
        tree.className = "nav nav-stacked";
        tree.id = id;
        tree.AllNodes = {};
        tree.Nodes = [];
        tree.DefaultState = "ExpandAll";
        ...
        tree.AddNodes = function (id, text, pid, icon, url, checked) {
            ...
            lable.Node = node;
            node.Label = lable;
            lable.className = "dropdown-collapse";
            ...
            iconDown.className ="icon-angle-down angle-down";
            node.Cpation = iconDown;
            ...
            if (pnode) {
                ...
                if (!cnodes) {
                    ...
                    cnodes.className = "nav nav-stacked";
