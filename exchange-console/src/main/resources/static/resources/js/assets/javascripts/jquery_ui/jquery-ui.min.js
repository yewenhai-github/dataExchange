...
function(t, e) {
	...
	t.widget("ui.tabs", {
		...
		_refresh: function() {
			...
			this.active.length ? (this.active.addClass("ui-tabs-active ui-state-active cxgbys").attr({
				"aria-selected": "true",
				tabIndex: 0
		...
		_toggle: function(e, i) {
			...
			function n() {
				i.newTab.closest("li").addClass("ui-tabs-active ui-state-active cxgbys"),
			...
			function() {
				i.oldTab.closest("li").removeClass("ui-tabs-active ui-state-active cxgbys"),
				n()
			}) : (i.oldTab.closest("li").removeClass("ui-tabs-active ui-state-active cxgbys"), r.hide(), n()),
			r.attr({
				"aria-expanded": "false",
				"aria-hidden": "true"
			}),
		...
		_destroy: function() {
			...
			this.tabs.add(this.panels).each(function() {
				t.data(this, "ui-tabs-destroy") ? t(this).remove() : t(this).removeClass("ui-state-default ui-state-active ui-state-disabled ui-corner-top ui-corner-bottom ui-widget-content ui-tabs-active ui-tabs-panel cxgbys").removeAttr("tabIndex").removeAttr("aria-live").removeAttr("aria-busy").removeAttr("aria-selected").removeAttr("aria-labelledby").removeAttr("aria-hidden").removeAttr("aria-expanded").removeAttr("role")
			}),
