...
$.widget( "ui.iviewer", $.ui.mouse, {
    ...
    **/
    createui: function()
    {
        ...
        $("<div>", { 'class': "iviewer_zoom_in iviewer_common  icon-zoom-in iviewer_button"})
                    .bind('mousedown touchstart',function(){me.zoom_by(1); return false;})
                    .appendTo(this.container);

        $("<div>", { 'class': "iviewer_zoom_out iviewer_common  icon-zoom-out iviewer_button"})
                    .bind('mousedown touchstart',function(){me.zoom_by(- 1); return false;})
                    .appendTo(this.container);
        ...
        $("<div>", { 'class': "iviewer_rotate_left iviewer_common icon-rotate-left iviewer_button"})
                    .bind('mousedown touchstart',function(){me.angle(-90); return false;})
                    .appendTo(this.container);

        $("<div>", { 'class': "iviewer_rotate_right iviewer_common icon-rotate-right iviewer_button" })
                    .bind('mousedown touchstart',function(){me.angle(90); return false;})
                    .appendTo(this.container);
					
        $("<div>", { 'class': "iviewer_rotateleft_left iviewer_common icon-arrow-left iviewer_button",'id':'picPrev' })
.bind('click',function(){
	        //getPicIndx(PicIndx,"prev");
			//$("#viewer1>img").attr("src","GetAttachment?INDX="+PicIndx)
	        getPic("pre");
			return false;
			})
                    .appendTo(this.container);
        $("<div>", { 'class': "iviewer_rotateright_right iviewer_common icon-arrow-right iviewer_button",'id':'picNext'})
.bind('click',function(){
	        //getPicIndx(PicIndx,"next");
			//$("#viewer1>img").attr("src","GetAttachment?INDX="+PicIndx)
			getPic("next");
			return false;
			})
