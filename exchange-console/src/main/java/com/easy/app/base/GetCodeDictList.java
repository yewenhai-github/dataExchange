...
@WebServlet("/base/GetCodeDictList")


public class GetCodeDictList extends MainServlet{
	public void DoCommand() throws Exception{
		...
		if(order == null || order.length() <= 0)
			order = "desc";
		String sql=SQLMap.getSelect("GetCodeDictList"); 
		 if(CODE_TYPE != null && CODE_TYPE.length() > 0)
			 sql=sql+" AND CODE_TYPE='"+CODE_TYPE+"' ";
