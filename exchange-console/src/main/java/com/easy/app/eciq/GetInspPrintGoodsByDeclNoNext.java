...
@WebServlet("/forms/GetInspPrintGoodsByDeclNoNext")
public class GetInspPrintGoodsByDeclNoNext extends MainServlet {

	private static final long serialVersionUID = 7002448616421263447L;

	public GetInspPrintGoodsByDeclNoNext(){
		this.SetCheckLogin(false);
	}
	
	public void DoCommand() throws Exception{
		InitFormData("inspDataPrint",SQLMap.getSelect("GetInspPrintById"));
		InitFormData("InspGoodsPrint",SQLMap.getSelect("GetInspGoodsListPrintNext"));
		//货物总值
