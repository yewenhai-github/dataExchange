...
@WebServlet("/forms/GetInspPrintGoodsByDeclNo")
public class GetInspPrintGoodsByDeclNo extends MainServlet {

	private static final long serialVersionUID = 7002448616421263447L;

	public GetInspPrintGoodsByDeclNo(){
		this.SetCheckLogin(false);
	}
	
	public void DoCommand() throws Exception{
		InitFormData("inspDataPrint",SQLMap.getSelect("GetInspPrintById"));
		InitFormData("InspGoodsPrint",SQLMap.getSelect("GetInspGoodsListPrintAll"));
		//货物总值
