...
@WebServlet("/DelDB2AnyXmlByPIndx")
public class DelDB2AnyXmlByPIndx extends MainServlet {
	    ...
	    if(SysUtility.isNotEmpty(params)){
	    	...
	    	for(int i=0;i<params.length();i++){
				...
				try {
					...
					datas.SetTableValue("DB2AnyData", "INDX", SysUtility.getJsonField(jobj, "INDX"));
					datas.SetTableValue("DB2AnyData", "P_INDX", SysUtility.getJsonField(jobj, "P_INDX"));
					Success++;
