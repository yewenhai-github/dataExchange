...
@WebServlet("/Audit02Api2ServerQuartz")
public class Audit02Api2ServerQuartz extends MainServlet {
	...
	public void DoCommand() throws Exception{
		...
		HashMap map = Utility.AuditTableAllDB(params, "exs_config_xmltomq", this);
