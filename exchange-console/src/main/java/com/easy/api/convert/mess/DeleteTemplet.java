...
public class DeleteTemplet   extends MainServlet {
	...
	public void DoCommand() throws Exception{
		...
		if(SysUtility.isNotEmpty(ids)) {
			String sql = "delete from exs_convert_templet where INDX in("+ids+")";
		...
		if(SysUtility.isNotEmpty(GetDataValue("TempletDATA", "INDX")))
		{
			DeleteDB("TempletDATA", "exs_convert_templet");
			ReturnMessage(true, "删除成功！");
		}else{
