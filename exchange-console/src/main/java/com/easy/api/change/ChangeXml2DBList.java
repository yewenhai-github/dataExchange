...
@WebServlet("/ChangeXml2DBList")
public class ChangeXml2DBList extends MainServlet{
 ...
 */
	private void changeByIndx(String[] strIndxs,String fromisEnabled,String toisEnabled,String test) throws LegendException {
		...
		SelectSQL.append("SELECT * FROM EXS_CONFIG_XMLTODB WHERE 1=1 "+conditions+" AND IS_ENABLED='"+fromisEnabled+"'");
		...
		if(size!=0){
			...
			UpdateSQL.append("UPDATE  EXS_CONFIG_XMLTODB  SET IS_ENABLED = ? WHERE 1=1 "+conditions);
