...
@WebServlet("/ChangeMq2XmlList")
public class ChangeMq2XmlList extends MainServlet{
 ...
 */
	private void changeByIndx(String[] strIndxs,String fromisEnabled,String toisEnabled,String test) throws LegendException {
		...
		SelectSQL.append("SELECT * FROM exs_config_mqtoxml WHERE 1=1 "+conditions+" AND IS_ENABLED='"+fromisEnabled+"'");
		...
		if(size!=0){
			...
			UpdateSQL.append("UPDATE  exs_config_mqtoxml  SET IS_ENABLED = ? WHERE 1=1 "+conditions);
