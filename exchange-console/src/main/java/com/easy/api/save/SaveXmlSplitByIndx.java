...
@WebServlet("/SaveXmlSplitByIndx")
public class SaveXmlSplitByIndx extends MainServlet {
	...
	public void DoCommand() throws Exception {
		...
		if (!SysUtility.isEmpty(indx)) {
			Datas datas = getDataAccess().GetTableDatas("TEMP", "select * from exs_config_xmltosplit where indx = ?", indx);
		...
		SaveToDB("XmlData", "exs_config_xmltosplit");
